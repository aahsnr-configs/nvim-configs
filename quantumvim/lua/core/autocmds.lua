...
-- 2. Trailing White-space Pruning on Save
-- NOTE: This is a synchronous in-process regex on the save path. It is
-- intentionally simple/fast for typical buffer sizes; for very large files
-- defer to a format-on-save formatter (conform.nvim) instead.
autocmd("BufWritePre", {
  group = core_group,
  pattern = "*",
...
-- 4. Strip Persistent Inline Comment Continuations on Carriage Return
autocmd("FileType", {
  group = core_group,
  pattern = "*",
