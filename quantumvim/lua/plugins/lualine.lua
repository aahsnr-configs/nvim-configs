...
return {
  ...
  config = function()
    ...
    local function get_scheme_color(group, attr, fallback)
    ...
    local colors = {
      bg = get_scheme_color("StatusLine", "bg", "#202328"),
      fg = get_scheme_color("StatusLine", "fg", "#bbc2cf"),
      yellow = get_scheme_color("DiagnosticWarn", "fg", "#ECBE7B"),
      cyan = get_scheme_color("Special", "fg", "#008080"),
      darkblue = get_scheme_color("DiffText", "bg", "#081633"),
      green = get_scheme_color("String", "fg", "#98be65"),
      orange = get_scheme_color("Constant", "fg", "#FF8800"),
      violet = get_scheme_color("Keyword", "fg", "#a9a1e1"),
      magenta = get_scheme_color("Type", "fg", "#c678dd"),
      blue = get_scheme_color("Function", "fg", "#51afef"),
      red = get_scheme_color("DiagnosticError", "fg", "#ec5f67"),
    }
